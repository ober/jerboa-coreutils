#!chezscheme
;;; sha256sum.sls -- SHA256 hash

(library (jerboa-coreutils sha256sum)
  (export main)
  ...
  (def (parse-check-line line)
    (let ((len (string-length line)))
      (cond
        ((and (>= len 7) (string-prefix? "SHA256 (" line))
  ...
  (def (main . args)
    (parameterize ((program-name "sha256sum"))
      ...
      (call-with-getopt
        ...
        args
        'program: "sha256sum"
        'help: "Print or check SHA256 message digests."
